    ...
    if (ev.which == 13 || ev.type == "change") {
        ...
        var table = $('#tablaOCCodigos').DataTable({
            ...
            ajax: {
                ...
                url: url,
                type: 'POST',
                data: { OC: oc, ocRevision, revision }
            },
...
function cargarTablaLineas(oc,revision) {
    ...
    var table = $('#tablaVisorLineasQR').DataTable({
        ...
        columns: [
            { title: 'No. de Línea', width: '08%' },
            { title: 'Código', width: '08%' },
            { title: 'Descripción', width: '16%' },
            { title: 'Cantidad', width: '08%' },
            { title: 'Unidad', width: '10%' },
            { title: 'Lote', width: '10%' },
            { title: 'QR', width: '10%' },
 ...
 *** lineas de la  OC
***/
function convertToPDF(oc,revision,ocLote) {
