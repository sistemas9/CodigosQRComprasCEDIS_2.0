...
namespace CodigosQRComprasCEDIS_2._0.TestHelper
{
  public class AuthenticationHeader
  {
    ...
    public async Task<String> getAuthenticationHeader(String company)
    {
      ...
      {
        if (config == "DESARROLLO")
          urlToken = await configs.GetConfigurationData("URL_TOKEN_LIN_TES");
        else
          urlToken = await configs.GetConfigurationData("URL_TOKEN_LIN_PROD");
      }
      /////////////////////////////////////generar token/////////////////////////////////////////////////////////////////////////////
